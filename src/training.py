...
features = ['yearly_income','is_female','is_married','colg_edu','is_professional',
            'is_retired','is_unemployed','months_residence','dual_income',
            'have_minors','own_house','race_white','speak_english']
numeric_features = ['yearly_income','months_residence']
categorical_features = ['is_female','is_married','colg_edu','is_professional',
                        'is_retired','is_unemployed','dual_income','have_minors',
                        'own_house','race_white','speak_english']
